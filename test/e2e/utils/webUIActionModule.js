...
/**
 * touchActions: perform single touch on the element
 * 
 * @param elementName: element created to web page interaction
 * 
 * @result: return type of element action boolean (true/false)
 */
exports.touchActions = function (elementName) {
	let _result = false;
	
	_element = uiMapModule.getExcelUIMap(elementName);
	
	try {
		browser.driver.touchActions(_element).perform();
		// browser.touchActions(_element).perform();
